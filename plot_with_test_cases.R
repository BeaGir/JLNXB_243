...
#testing cases for plotting functions
plot_factor_scores(mymfa)
plot_factor_scores(mymfa, 1, 3)
plot_pfs(mymfa, 1)
plot_vl(mymfa, 1)
plot_vl(mymfa, 1, loading_labels = c("Cat Pee", "Passion Fruit", "Green Pepper", "Mineral", "Smoky", "Citrus"))
plot_pfs_vl(mymfa, 1)
plot_pfs_vl(mymfa, 1, loading_labels = c("Cat Pee", "Passion Fruit", "Green Pepper", "Mineral", "Smoky", "Citrus"))
...
plot(mymfa, type = 3, loading_labels = loading_labels)
plot(mymfa, type = 4, X = 1) 
plot(mymfa, type = 5, X = 1) 
plot(mymfa, type = 5, X = 1, loading_labels = loading_labels$a) 
