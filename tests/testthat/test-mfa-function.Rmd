...
test_that("mfa function yields correct first partial factor score", {
  ...
  expect_identical(round(mfa(wines, sets, ncomps = 2, center = TRUE, scale = scaling_vec)$partial_factor_scores[[1]], 3), matrix(c(-1.037, -1.179, -0.213, -0.946, 1.546, 1.176, 0.698, 1.006, -0.922, 0.189, -0.643, 0.323, 0.155, 0.596, -0.104, 0.446, -0.676, -0.747, 0.166, -0.063, 0.486, -0.936, 0.640, 0.036), 12))
